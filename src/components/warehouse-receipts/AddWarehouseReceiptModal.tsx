...
export default function AddWarehouseReceiptModal({
  open,
  onOpenChange,
  suppliers,
}: {
  ...
  const handleSubmit = () => {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        toast.success("Warehouse receipt created.");
        onOpenChange(false);
      } else {
        toast.error(result.error ?? "Failed to create warehouse receipt.");
      }
    });
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="shrink-0 px-6 pt-6 pb-0">
          ...
          <DialogDescription>Record incoming stock items.</DialogDescription>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                <SelectTrigger id="add-wr-supplier">
                  <SelectValue>
                    {supplierId
            ...
            <div className="flex flex-col gap-1.5 col-span-2">
              <Label htmlFor="add-wr-notes">Notes</Label>
              <Textarea
                id="add-wr-notes"
          ...
          <div className="flex flex-col gap-3">
            ...
            {items.map((row, i) => (
              <div
                key={i}
                className="grid grid-cols-[1fr_70px_100px_110px_110px_120px_32px] gap-2 items-center"
              >
                <ProductCombobox
                  options={products}
